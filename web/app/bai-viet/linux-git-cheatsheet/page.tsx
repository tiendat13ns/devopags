    ...
    <header className="sticky top-0 z-50 border-b border-border/80 bg-white/90 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          <a className="hidden h-9 items-center gap-2 rounded-lg border border-border bg-white px-3.5 text-sm font-semibold transition-colors hover:border-primary/30 hover:bg-accent sm:flex" href="https://github.com/tiendat13ns/devopags" target="_blank" rel="noreferrer">
